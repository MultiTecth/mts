...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.viandian.my.id/">Belajar Botak</a></p>
        </div>
...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.viandian.my.id//">
                    Belajar Botak </a></p>
        </div>
        <div class="col-md-10 mx-auto col-lg-5">
